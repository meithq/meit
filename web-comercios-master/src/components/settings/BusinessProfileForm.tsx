...
export function BusinessProfileForm({ initialData }: BusinessProfileFormProps) {
  ...
  const {
    ...
    defaultValues: {
      ...
      business_type: initialData?.business_type || 'panaderia',
      phone: initialData?.phone || '',
      address: initialData?.address || '',
      business_hours_open: initialData?.business_hours_open || '09:00',
      business_hours_close: initialData?.business_hours_close || '18:00',
