...
import { signInWithEmail, signInWithGoogle, updateLastLogin } from "@/lib/supabase/auth"
  ...
  return (
    <form className={cn("flex flex-col gap-6", className)} onSubmit={handleSubmit} {...props}>
      ...
      <p className="text-center text-sm text-muted-foreground">
        ...
        <a href="/registro" className="text-primary underline underline-offset-4 hover:text-primary/80">
          Regístrate
        </a>
      </p>
    </form>
